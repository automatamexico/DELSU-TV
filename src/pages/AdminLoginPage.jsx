...
/**
 * Preflight RELAJADO (informativo, NO bloquea):
 * - Intenta /auth/v1/health y /auth/v1/settings
 * - Si alguna da 2xx marca ok=true
 * - Si falla, solo registra y seguimos con el login
 */
...
export default function AdminLoginPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      // 0) Preflight relajado (solo informa)
