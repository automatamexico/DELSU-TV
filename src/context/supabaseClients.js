...
import { supabase } from '../supabaseClientCore'; // Importa SIEMPRE del core
...
export function AuthProvider({ children }) {
  ...
  const signUp = useCallback(async (...args) => {
    ...
    // Si requiere confirmación por email, intenta iniciar sesión; si no se puede, informa
    try {
  ...
  // ====== NUEVO: subir avatar a Storage y guardar URL ======
